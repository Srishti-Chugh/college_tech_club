...
// ─── CSS ──────────────────────────────────────────────────────────────────────
const CSS = `
  @import url('https://fonts.googleapis.com/css2?family=Geist+Mono:wght@400;500;600;700&family=Unbounded:wght@400;600;700;800&display=swap');
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}

  .ll-root{
    min-height:100vh; background:#07080f; color:rgba(255,255,255,.92);
  ...
  /* BG */
  .ll-bg{position:fixed;inset:0;pointer-events:none;z-index:0}
  .ll-orb{position:absolute;border-radius:50%;filter:blur(130px);opacity:.09;transition:background 0.8s ease}
  .ll-orb1{width:750px;height:750px;top:-300px;left:-220px}
  .ll-orb2{width:500px;height:500px;background:#818cf8;bottom:-100px;right:-160px}
  .ll-grid{
  ...
  .ll-back{
    ...
    color:rgba(255,255,255,.3);font-family:'Geist Mono',monospace;font-size:.8rem;transition:color .2s;
  }
  .ll-back:hover{color:rgba(255,255,255,.65)}

  /* Header */
  .ll-header{position:relative;z-index:2;text-align:center;margin-top:2.5rem;max-width:740px;width:100%}
  .ll-badge{
    display:inline-block;font-size:.67rem;letter-spacing:.14em;text-transform:uppercase;
    border:1px solid;border-radius:100px;padding:.27rem .85rem;margin-bottom:1rem;transition:all .4s;
  }
  .ll-title{
    font-family:'Unbounded',sans-serif;
    font-size:clamp(2.6rem,8vw,5rem);font-weight:800;letter-spacing:-.04em;line-height:.95;
    background-clip:text;-webkit-background-clip:text;-webkit-text-fill-color:transparent;transition:background-image .4s;
  }
  .ll-subtitle{margin-top:.9rem;color:rgba(255,255,255,.38);font-size:.8rem;line-height:1.7;transition:all .3s;max-width:580px;margin-inline:auto}
  .ll-stats{display:flex;justify-content:center;gap:.75rem;flex-wrap:wrap;margin-top:1.4rem}
  .ll-stat{
    display:flex;flex-direction:column;align-items:center;gap:.18rem;
    background:rgba(255,255,255,.035);border:1px solid rgba(255,255,255,.07);border-radius:12px;padding:.6rem 1rem;
  }
  .ll-stat-code{font-size:.95rem;font-weight:600;transition:color .3s}
  .ll-stat-label{font-size:.65rem;color:rgba(255,255,255,.32)}
  .ll-features{display:flex;flex-wrap:wrap;justify-content:center;gap:.45rem;margin-top:1rem}
  .ll-feature{
    font-size:.7rem;padding:.22rem .7rem;border-radius:8px;border:1px solid;
    display:flex;align-items:center;transition:all .3s;
  }

  /* Playground wrap */
  .pg-wrap{
    position:relative;z-index:2;width:100%;max-width:900px;margin-top:2.5rem;
  ...
  .ll-toggle-row{
    ...
    background:rgba(0,0,0,.35);border:1px solid rgba(255,255,255,.06);border-radius:14px;padding:.38rem;
    margin-bottom:1.4rem;
  }
  .ll-toggle-btn{
    flex:1;min-width:130px;background:transparent;border:1px solid transparent;border-radius:10px;
    color:rgba(255,255,255,.35);font-family:'Geist Mono',monospace;font-size:.75rem;
    padding:.52rem .5rem;cursor:pointer;transition:all .22s;white-space:nowrap;text-align:center;
  }
  .ll-toggle-btn:hover{color:rgba(255,255,255,.65)}
  .ll-toggle-btn.active{font-weight:600}
  ...
  .pg-chip{font-size:.68rem;padding:.2rem .65rem;border-radius:100px;border:1px solid;letter-spacing:.04em;transition:all .3s}
  .pg-reset{
    background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);
    color:rgba(255,255,255,.38);font-family:'Geist Mono',monospace;font-size:.75rem;
    border-radius:8px;padding:.33rem .8rem;cursor:pointer;transition:all .2s;
  }
  .pg-reset:hover{color:#fff;border-color:rgba(255,255,255,.2)}

  /* Visualizer */
  .pg-viz{
    background:rgba(0,0,0,.28);border:1px solid rgba(255,255,255,.06);border-radius:14px;
    padding:1rem .75rem;min-height:110px;overflow-x:auto;margin-bottom:.9rem;
    display:flex;align-items:center;
  }

  .pg-legend{display:flex;gap:.75rem;flex-wrap:wrap;justify-content:center;margin-bottom:1.2rem}
  .pg-leg{display:flex;align-items:center;gap:.32rem;font-size:.7rem;color:rgba(255,255,255,.35)}
  .pg-leg-dot{width:9px;height:9px;border-radius:3px;flex-shrink:0}
  ...
  .pg-card-head{display:flex;align-items:center;gap:.65rem;padding:.78rem 1rem;background:rgba(255,255,255,.025)}
  .pg-card-icon{font-size:.9rem;width:18px;text-align:center;flex-shrink:0}
  .pg-card-name{font-weight:600;font-size:.88rem;flex:1}
  .ll-op-badge{font-size:.66rem;padding:.16rem .52rem;border-radius:100px;border:1px solid;letter-spacing:.04em;transition:all .3s;flex-shrink:0}
  .pg-chev{color:rgba(255,255,255,.25);transition:transform .2s;flex-shrink:0}
  .pg-chev.rot{transform:rotate(180deg)}
  .pg-card-body{
    padding:.85rem 1rem 1rem;display:flex;flex-direction:column;gap:.5rem;
    background:rgba(0,0,0,.22);border-top:1px solid rgba(255,255,255,.05);
  }
  .pg-row{display:flex;gap:.42rem;align-items:center;flex-wrap:wrap}
  .pg-inp{
    flex:1;min-width:80px;
    background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);
    color:#fff;font-family:'Geist Mono',monospace;font-size:.84rem;
    border-radius:9px;padding:.48rem .72rem;outline:none;transition:border-color .2s;
  }
  .pg-inp.sm{flex:0 0 88px}
  .pg-inp:focus{border-color:rgba(255,255,255,.28)}
  .pg-inp::placeholder{color:rgba(255,255,255,.2)}
  .pg-btn{
    border:none;border-radius:9px;cursor:pointer;
    font-family:'Geist Mono',monospace;font-weight:500;font-size:.8rem;
    padding:.48rem .9rem;transition:opacity .15s, transform .1s;white-space:nowrap;
  }
  .pg-btn:hover{opacity:.82;transform:translateY(-1px)}
  .pg-hint{font-size:.73rem;color:rgba(255,255,255,.28);line-height:1.65}

  /* Log */
  .pg-log{
    margin-top:1.2rem;background:rgba(0,0,0,.38);border:1px solid rgba(255,255,255,.055);
    border-radius:11px;padding:.7rem .9rem;max-height:150px;overflow-y:auto;
    display:flex;flex-direction:column;gap:.25rem;
  }
  .pg-log-lbl{font-size:.6rem;text-transform:uppercase;letter-spacing:.1em;color:rgba(255,255,255,.2);margin-bottom:.25rem}
  .pg-log-e{font-size:.74rem;display:flex;gap:.4rem;align-items:flex-start;color:rgba(255,255,255,.38);line-height:1.55}
  .pg-log-e.success{color:#4ade80}
  .pg-log-e.error{color:#f87171}
  .pg-log-e.highlight{color:#a78bfa}
  .pg-log-e.info{color:rgba(255,255,255,.36)}
  .pg-log-arr{opacity:.4;flex-shrink:0}
  ...
  .pt-title{font-family:'Unbounded',sans-serif;font-size:1.2rem;font-weight:700;letter-spacing:-.02em}
  ...
  .pt-cnt{font-size:.71rem;padding:.22rem .65rem;border-radius:100px;border:1px solid}
  .pt-cnt.easy{color:#4ade80;background:rgba(74,222,128,.1);border-color:rgba(74,222,128,.25)}
  .pt-cnt.medium{color:#fb923c;background:rgba(251,146,60,.1);border-color:rgba(251,146,60,.25)}
  .pt-cnt.hard{color:#f87171;background:rgba(248,113,113,.1);border-color:rgba(248,113,113,.25)}

  .pt-filters{display:flex;gap:.38rem;margin-bottom:.85rem;flex-wrap:wrap}
  .pt-f{
    background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.08);
    color:rgba(255,255,255,.42);font-family:'Geist Mono',monospace;font-size:.76rem;
    border-radius:9px;padding:.36rem .82rem;cursor:pointer;display:flex;align-items:center;gap:.35rem;transition:all .18s;
  }
  ...
  .pt-tbl-wrap{border:1px solid rgba(255,255,255,.07);border-radius:16px;overflow:hidden}
  ...
  .pt-row:hover{background:rgba(255,255,255,.025)}
  ...
  .pt-topic{color:rgba(255,255,255,.33);font-size:.73rem}
  .pt-acc{color:rgba(255,255,255,.3);font-size:.73rem}
  ...
  @media(max-width:620px){
    .ll-toggle-btn{min-width:90px;font-size:.68rem;padding:.45rem .35rem}
    .pt-tbl th:nth-child(4),.pt-tbl td:nth-child(4),
    .pt-tbl th:nth-child(5),.pt-tbl td:nth-child(5){display:none}
    .pg-wrap{padding:1.25rem 1rem}
  }
`;
