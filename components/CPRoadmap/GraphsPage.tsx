...
// ─── Styles ────────────────────────────────────────────────────────────────────
const CSS = `
  @import url('https://fonts.googleapis.com/css2?family=Sora:wght@400;500;600;700;800&family=Fira+Code:wght@400;500;600&display=swap');
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* ── BG ── */
  .gp-bg { position: fixed; inset: 0; pointer-events: none; z-index: 0; }
  .gp-orb { position: absolute; border-radius: 50%; filter: blur(140px); opacity: .08; transition: background 1s; }
  .gp-o1 { width: 800px; height: 800px; top: -350px; left: -250px; }
  .gp-o2 { width: 600px; height: 600px; background: #7c3aed; bottom: -200px; right: -200px; }
  .gp-grid {
  ...
  .gp-back {
    ...
    color: rgba(255,255,255,.3); font-family: 'Fira Code', monospace; font-size: .78rem;
    transition: color .2s;
  }
  .gp-back:hover { color: rgba(255,255,255,.65); }
  ...
  .gp-badge {
    ...
    border: 1px solid; border-radius: 100px; padding: .28rem .9rem; margin-bottom: 1.1rem;
    transition: all .4s;
  }
  .gp-title {
  ...
  .gp-subtitle {
    margin-top: 1rem; color: rgba(255,255,255,.4);
    font-family: 'Fira Code', monospace; font-size: .8rem; line-height: 1.75;
  ...
  .gp-stat-val { font-family: 'Fira Code', monospace; font-size: .92rem; font-weight: 600; transition: color .4s; }
  .gp-stat-lbl { font-size: .62rem; color: rgba(255,255,255,.3); }
  ...
  .gp-type-toggle {
    ...
    border-radius: 14px; padding: .38rem;
    margin-bottom: 1.5rem;
  }
  .gp-type-btn {
    flex: 1; min-width: 130px;
    background: transparent; border: 1px solid transparent; border-radius: 10px;
    color: rgba(255,255,255,.32); font-family: 'Sora', sans-serif;
    font-size: .76rem; font-weight: 500;
    padding: .55rem .5rem; cursor: pointer; transition: all .22s;
    display: flex; align-items: center; justify-content: center; gap: .45rem;
    text-align: center;
  }
  .gp-type-btn:hover:not(:disabled) { color: rgba(255,255,255,.7); }
  .gp-type-btn.active { font-weight: 700; }
  .gp-type-btn:disabled { cursor: not-allowed; opacity: .5; }
  .gp-type-icon { font-size: 1rem; }

  /* Playground header */
  .gp-pg-header {
    display: flex; justify-content: space-between; align-items: center;
    margin-bottom: 1.25rem; gap: .5rem; flex-wrap: wrap;
  }
  .gp-pg-title {
  ...
  .gp-chip {
    ...
    font-size: .66rem; padding: .2rem .7rem; border-radius: 100px;
    border: 1px solid; letter-spacing: .04em; transition: all .3s;
  }
  .gp-reset-btn {
    background: rgba(255,255,255,.05); border: 1px solid rgba(255,255,255,.1);
    color: rgba(255,255,255,.5); font-family: 'Fira Code', monospace;
    font-size: .76rem; border-radius: 9px; padding: .38rem .9rem;
    cursor: pointer; transition: all .2s;
  }
  .gp-reset-btn:hover:not(:disabled) { color: #fff; border-color: rgba(255,255,255,.25); }
  .gp-reset-btn:disabled { opacity: .35; cursor: not-allowed; }
  ...
  .gp-svg { width: 100%; height: auto; overflow: visible; }
  ...
  .gp-leg-dot { width: 9px; height: 9px; border-radius: 3px; flex-shrink: 0; }
  ...
  .gp-adj-title {
    ...
    color: rgba(255,255,255,.25); margin-bottom: .65rem;
  }
  .gp-adj-row {
    display: flex; align-items: baseline; gap: .35rem;
    margin-bottom: .32rem; font-family: 'Fira Code', monospace; font-size: .76rem;
  }
  .gp-adj-node { font-weight: 700; min-width: 18px; }
  .gp-adj-arrow { color: rgba(255,255,255,.25); }
  .gp-adj-nbrs { color: rgba(255,255,255,.5); word-break: break-all; }
  ...
  .gp-input-row { display: flex; align-items: center; gap: .5rem; }
  .gp-input-label {
    font-family: 'Fira Code', monospace; font-size: .72rem;
    color: rgba(255,255,255,.35); min-width: 36px;
  }
  .gp-input {
    flex: 1; background: rgba(255,255,255,.06);
    border: 1px solid rgba(255,255,255,.1); border-radius: 8px;
    color: #fff; font-family: 'Fira Code', monospace; font-size: .84rem;
    padding: .38rem .6rem; outline: none; transition: border-color .2s;
    width: 0;
  }
  .gp-input:focus { border-color: rgba(255,255,255,.28); }
  .gp-input::placeholder { color: rgba(255,255,255,.2); }
  .gp-input:disabled { opacity: .45; cursor: not-allowed; }
  ...
  .gp-algo-card:hover { border-color: rgba(255,255,255,.16); }
  .gp-algo-head {
    display: flex; align-items: center; gap: .7rem;
    padding: .85rem 1rem; background: rgba(255,255,255,.025);
  }
  .gp-algo-icon { font-size: 1.2rem; flex-shrink: 0; }
  .gp-algo-name { font-weight: 700; font-size: .92rem; }
  .gp-algo-sub { font-family: 'Fira Code', monospace; font-size: .68rem; color: rgba(255,255,255,.3); margin-top: .1rem; }
  .gp-algo-badge {
    margin-left: auto; flex-shrink: 0;
    font-family: 'Fira Code', monospace; font-size: .63rem;
    padding: .17rem .55rem; border-radius: 100px; border: 1px solid;
  ...
  .gp-run-btn {
    ...
    padding: .65rem 1.25rem; transition: opacity .15s, transform .1s;
    align-self: flex-start;
  }
  .gp-run-btn:hover:not(:disabled) { opacity: .85; transform: translateY(-1px); }
  .gp-run-btn:disabled { opacity: .45; cursor: not-allowed; }
  ...
  .gp-log-line.success { color: #4ade80; }
  .gp-log-line.error   { color: #f87171; }
  .gp-log-line.step    { color: #a5b4fc; }
  .gp-log-line.info    { color: rgba(255,255,255,.36); }
  .gp-log-arrow { opacity: .4; flex-shrink: 0; }

  /* ── Problems ── */
  .pt-wrap { position: relative; z-index: 2; width: 100%; max-width: 980px; margin-top: 3rem; }
  .pt-hdr { display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 1rem; margin-bottom: 1.1rem; }
  .pt-title { font-size: 1.35rem; font-weight: 800; letter-spacing: -.03em; }
  .pt-sub { font-family: 'Fira Code', monospace; font-size: .74rem; color: rgba(255,255,255,.3); margin-top: .25rem; }
  .pt-counts { display: flex; gap: .4rem; flex-wrap: wrap; align-items: center; }
  .ptc { font-family: 'Fira Code', monospace; font-size: .71rem; padding: .22rem .65rem; border-radius: 100px; border: 1px solid; }
  ...
  .pt-f {
    ...
    color: rgba(255,255,255,.42); font-family: 'Fira Code', monospace; font-size: .76rem;
    border-radius: 9px; padding: .38rem .85rem; cursor: pointer;
    display: flex; align-items: center; gap: .35rem; transition: all .18s;
  }
  ...
  .pt-f.active.easy   { color: #4ade80; border-color: rgba(74,222,128,.4);  background: rgba(74,222,128,.09); }
  .pt-f.active.medium { color: #fb923c; border-color: rgba(251,146,60,.4);  background: rgba(251,146,60,.09); }
  .pt-f.active.hard   { color: #f87171; border-color: rgba(248,113,113,.4); background: rgba(248,113,113,.09); }
  .pt-fc { background: rgba(255,255,255,.1); border-radius: 100px; font-size: .63rem; padding: .03rem .4rem; }
  ...
  .pt-tbl th { text-align: left; padding: .7rem 1rem; font-family: 'Fira Code', monospace; font-size: .64rem; font-weight: 700; letter-spacing: .08em; text-transform: uppercase; color: rgba(255,255,255,.26); }
  ...
  .pt-tbl td { padding: .75rem 1rem; font-size: .84rem; }
  .pt-num   { color: rgba(255,255,255,.2); font-family: 'Fira Code', monospace; font-size: .72rem; width: 36px; }
  .pt-name  { font-weight: 600; color: rgba(255,255,255,.85); }
  .pt-topic { color: rgba(255,255,255,.33); font-family: 'Fira Code', monospace; font-size: .73rem; }
  .pt-acc   { color: rgba(255,255,255,.3);  font-family: 'Fira Code', monospace; font-size: .73rem; }
  .pt-diff  { font-family: 'Fira Code', monospace; font-size: .68rem; font-weight: 700; padding: .18rem .6rem; border-radius: 100px; letter-spacing: .04em; }
  ...
  .pt-solve { color: #60a5fa; font-family: 'Fira Code', monospace; font-size: .76rem; text-decoration: none; white-space: nowrap; transition: color .14s; }
  .pt-solve:hover { color: #93c5fd; }

  @media (max-width: 680px) {
    .gp-algo-grid { grid-template-columns: 1fr; }
    .gp-right-panel { width: 100%; }
    .gp-canvas-row { flex-direction: column; }
    .gp-type-btn { min-width: 80px; font-size: .7rem; }
